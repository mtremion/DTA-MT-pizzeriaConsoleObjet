...
public class Pizza 
{
	...
	public Pizza(String pCode, String pLibelle, String pCategorie, double pPrix)
	{
		this();
		this.code = pCode;
		...
		this.categoriePizza = CategoriePizza.valueOf(pCategorie);

	}
	
	public Pizza(int pId, String pCode, String pLibelle, String pCategorie, double pPrix)
	{
		this.id = pId;
		this.code = pCode;
		this.libelle = pLibelle;
	...
	{
		return this.categoriePizza.getNom();
	}
